            ...
            for (var t = 0; t <= 2; t++) {
                ...
                for (var o = 0; o < n.length; o++) {
                    ...
                    i.test(s)
                        ...
                        : l.test(s) && (refmod == REFTYP.FOOTNOTE ? (r.setAttribute("href", "javascript:void(0)"), (r.onclick = m(REFTYP.REFERENCE, "references_" + t, r))) : r.setAttribute("href", "#references_" + t + s));
                }
