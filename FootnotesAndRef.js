function theReference(e) {
  // return true or false, depending on whether you want to allow the `href` property to follow through or not
  e.currentTarget.dataset.donotclose = "true";
  return true;
}
      ...
      for (var t = 0; t <= 2; t++) {
        ...
        for (var o = 0; o < n.length; o++) {
          ...
          i.test(s) ?
            ...
            l.test(s) && (refmod == REFTYP.FOOTNOTE ? (r.setAttribute("href", "javascript:void(0)"), (r.onclick = m(REFTYP.REFERENCE, "references_" + t, r))) : r.setAttribute("href", "#references_" + t + s), r.setAttribute("onclick", "return theReference(event);"), r.setAttribute("data-donotclose", "false"));
        }
