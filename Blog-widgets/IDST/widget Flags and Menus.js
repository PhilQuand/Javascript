...
<!-- article récupéré dela page alternative, mis en forme sur https://unminify.com et cache des drapeaux (display none des img correspondants)-->
<article style="background-color: rgba(190, 201, 228, 0.498039); background-position: initial initial; background-repeat: initial initial;">
    <div class="item-content float-container res-title">
        <h3 style="display: block;"><a href="https://www.linternationaledessavoirspourtous.org/2020/03/apres-marseille-retrouvons-nous-rome.html?lang=fr" onclick="return function gotoOnClick(e) {
  //alert(e.href + '&amp;lngloc=' + e.getAttribute(&quot;data-lngloc&quot;));
  window.location = e.href + '&amp;lngloc=' + e.getAttribute(&quot;data-lngloc&quot;);
  return false;
}(this);" data-lngloc="fr-FR"><div class="local-lang fr-FR" style="display: block;">Après Marseille, retrouvons-nous à Rome les 24 et 25 juin 2020&nbsp;!</div><div class="local-lang en-EN" style="display: none;">After Marseille, let's meet in Rome on June 24 and 25, 2020! </div><div class="local-lang de-DE" style="display: none;">Treffen wir uns nach Marseille am 24. und 25. Juni 2020 in Rom! </div><div class="local-lang es-ES" style="display: none;">¡Después de Marsella, reunámonos en Roma el 24 y 25 de junio de 2020! </div><div class="local-lang it-IT" style="display: none;">Dopo Marsiglia, incontriamoci a Roma il 24 e 25 giugno 2020!</div></a>
<img style="display:none" src="https://philquand.github.io/Javascript/flagsRepository/Italie.png" width="32" height="32" alt="it-IT" border="0" style="cursor:pointer; margin-left: 5px; float: right;" onclick="return setSumFlagsOnClick(this);" class="local-flags it-IT" />
<img style="display:none" src="https://philquand.github.io/Javascript/flagsRepository/Espagne.png" width="32" height="32" alt="es-ES" border="0" style="cursor:pointer; margin-left: 5px; float: right;" onclick="return setSumFlagsOnClick(this);" class="local-flags es-ES" />
<img style="display:none" src="https://philquand.github.io/Javascript/flagsRepository/Allemagne.png" width="32" height="32" alt="de-DE" border="0" style="cursor:pointer; margin-left: 5px; float: right;" onclick="return setSumFlagsOnClick(this);" class="local-flags de-DE" />
<img style="display:none" src="https://philquand.github.io/Javascript/flagsRepository/RoyaumesUnis.png" width="32" height="32" alt="en-EN" border="0" style="cursor:pointer; margin-left: 5px; float: right;" onclick="return setSumFlagsOnClick(this);" class="local-flags en-EN" />
<img style="display:none" src="https://philquand.github.io/Javascript/flagsRepository/France.png" width="32" height="32" alt="fr-FR" border="0" style="cursor:pointer; margin-left: 5px; float: right;" onclick="return setSumFlagsOnClick(this);" class="local-flags fr-FR" />
        ...
        <h3 style="display: none;"><div class="local-lang fr-FR" style="display: block;">Après Marseille, retrouvons-nous à Rome les 24 et 25 juin 2020&nbsp;!</div><div class="local-lang en-EN" style="display: none;">After Marseille, let's meet in Rome on June 24 and 25, 2020! </div><div class="local-lang de-DE" style="display: none;">Treffen wir uns nach Marseille am 24. und 25. Juni 2020 in Rom! </div><div class="local-lang es-ES" style="display: none;">¡Después de Marsella, reunámonos en Roma el 24 y 25 de junio de 2020! </div><div class="local-lang it-IT" style="display: none;">Dopo Marsiglia, incontriamoci a Roma il 24 e 25 giugno 2020!</div></h3>
        <h2 class="authors"><div class="local-lang fr-FR" style="display: block;">La Rédaction du blog</div><div class="local-lang en-EN" style="display: none;">Blog editorial team</div><div class="local-lang de-DE" style="display: none;">Blogredaktion</div><div class="local-lang es-ES" style="display: none;">La redacción del blog</div><div class="local-lang it-IT" style="display: none;">La redazione del blog</div></h2><img style="display: none;" class="res-img" src="" border="0" width="40px" onclick="showSummary(this)" /></div>
    <div style="display: block">
        <div class="post-header item-content float-container"><span class="imgSum"><img data-img="yes" src="https://1.bp.blogspot.com/-STyu1-_TmZ8/XmPcML99bUI/AAAAAAAAlKo/THUCHh05ZbsAHQb5UruBDHuD29mHQcz_gCLcBGAsYHQ/s1600/ImagePiazzaNavona.JPG" width="180px" height="auto" /></span>
            <div class="incrustation">
                <div class="local-lang fr-FR" style="display: block;">

                    Valeria Pinto, membre de l’IDST, a lancé en compagnie d’autres universitaires un appel intitulé «&nbsp;Désintoxiquons-nous. Le Savoir pour le futur&nbsp;», déjà soutenu par plus de 1300 signataires. L’un des objectifs de cet appel est d’organiser une rencontre à Rome les 24 et 25 juin 2020, au moment même où se tiendra dans la capitale italienne... </div>
                <div class="local-lang en-EN" style="display: none;">

                    Valeria Pinto, member of the International of Knowledge for All (IKA), together with other academics, launched a call entitled "Let's detoxify ourselves. Knowledge for the future", already supported by more than 1300 signatories. One of the objectives of this call is to organize a meeting in Rome on 24 and 25 June 2020, at the... </div>
                <div class="local-lang de-DE" style="display: none;">

                    Valeria Pinto, Mitglied des «&nbsp;Internationales Netzwerk Wissen für Alle&nbsp;» (INWA), hat zusammen mit anderen Akademikern einen Aufruf mit dem Titel “Entgiften wir uns – Wissen für die Zukunft”&nbsp;, das bereits von mehr als 1300 Unterzeichnern unterstützt wird. Eines der Ziele dieses Aufrufs ist die... </div>
                <div class="local-lang es-ES" style="display: none;">

                    Valeria Pinto, miembro de la IDST, junto con otros académicos, lanzó un llamamiento titulado "Desintoxiquémonos". Conocimiento para el futuro", ya apoyado por más de 1300 firmantes. Uno de los objetivos de esta convocatoria es organizar una reunión en Roma los días 24 y 25 de junio de 2020, al mismo... </div>
                <div class="local-lang it-IT" style="display: none;">

                    Valeria Pinto, membro dell’ L'Internazionale della Conoscenza per Tutti (ICT), ha lanciato, insieme ad altri universitari, un appello dal titolo “Disintossichiamoci. Sapere per il futuro”, già sostenuto da più di 1300 firmatari. Uno degli obiettivi di questo appello è... </div>
            </div>
            <div style="text-align: right; display: none;"><a class="jump-link myflat-button ripple" href="https://www.linternationaledessavoirspourtous.org/2019/01/a-lorigine-de-notre-internationale.html?lang=fr" title="À l’origine de notre Internationale">Lire la suite</a></div>
        </div>
    </div>
</article>
</div>
