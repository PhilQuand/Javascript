(function($) {
  $.fn.Class2Modal = function(options) {
    var _this = this;
    Promise.all([
    ...
    var imgBase= getIMG(title.split(' '));
    var hrefItem = { dataType : "inline", dataThumb: imgBase, dataSrc: corpsBR.html(), dataCaption: '<a href=&#34;' + hrefURL[i] + '&#34;>L&#39;article d&#39;origine</a>'};
    href.push(hrefItem);
       }
